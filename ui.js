...
function add_current_foe() {
  ...
  foe.base_index = parseInt(document.getElementById("Enemy").value);
  ...
  if (!document.getElementById("apply_to_all").checked) {
    ...
    foe.assumed_spd_buff = parseInt(document.getElementById("EnemySpdBuff").value);
    foe.assumed_def_buff = parseInt(document.getElementById("EnemyDefBuff").value);
    foe.assumed_res_buff = parseInt(document.getElementById("EnemyResBuff").value);
    foe.assumed_atk_boost = parseInt(document.getElementById("EnemyAtkBonus").value);
    foe.assumed_spd_boost = parseInt(document.getElementById("EnemySpdBonus").value);
    foe.assumed_def_boost = parseInt(document.getElementById("EnemyDefBonus").value);
    foe.assumed_res_boost = parseInt(document.getElementById("EnemyResBonus").value);
    foe.assumed_atk_penalty = parseInt(document.getElementById("EnemyAtkDebuff").value);
    foe.assumed_spd_penalty = parseInt(document.getElementById("EnemySpdDebuff").value);
    foe.assumed_def_penalty = parseInt(document.getElementById("EnemyDefDebuff").value);
    foe.assumed_res_penalty = parseInt(document.getElementById("EnemyResDebuff").value);
    ...
    foe.two_space = parseInt(document.getElementById("EnemyTwoSpaceAllies").value);
    foe.three_space = parseInt(document.getElementById("EnemyThreeSpaceAllies").value);
